...
/*[20190411,jx]To Avoid the interrupt to when flash-working*/
	...
	atomic_t u8_NVTflashWorking = ATOMIC_INIT(0);
#endif
...
static int32_t nvt_flash_open(struct inode *inode, struct file *file)
{
	...
	#if (NVTFLASH_WORK_PROTECT)		
		atomic_set(&u8_NVTflashWorking, 1);     //[20190411,jx]
		NVT_ERR("u8_NVTflashWorking=[%d]\n", atomic_read(&u8_NVTflashWorking));
	#endif
...
static int32_t nvt_flash_close_Spi(struct inode *inode, struct file *file)
{
	...
	#if (NVTFLASH_WORK_PROTECT)		
		atomic_set(&u8_NVTflashWorking, 0);    //[20190411,jx]
		NVT_ERR("u8_NVTflashWorking = [%d]\n", atomic_read(&u8_NVTflashWorking));
	#endif
...
static int32_t nvt_ts_point_data_checksum(uint8_t *buf, uint8_t length)
{
	...
	//[20190621]Add for NT36525, buf[1~64] is all 0x00
	if((buf[1] == 0x00)&&(checksum == 0x00)){
	   NVT_LOG("Checksum Reject!!!  buf[1]=%02X, checksum=%02X ,buf[length]=%02X\n"
	   	,buf[1], checksum, buf[length]);
       return -2;// ->buf[1~64] is all 0x00
	}
...
static int bbk_xxx_mode_change(int which) {
	...
	#if (NVTFLASH_WORK_PROTECT)
		atomic_set(&u8_NVTflashWorking, 0);
		NVT_ERR("u8_NVTflashWorking=[%d]\n", atomic_read(&u8_NVTflashWorking));
	#endif
...
static int bbk_xxx_get_ic_mode(void)
{
	uint8_t buf[8] = {0};
	int ret;
	if (ts_spi->mmap == NULL) {
	...
	nvt_set_page(ts_spi->mmap->EVENT_BUF_ADDR | 0x41);
...
#include "firmware/PD1901_no_flash_fw_36525b_boe_1211701.h"
#include "firmware/PD1901_no_flash_fw_36525b_boe_1211701_mp.h"
#include "firmware/PD1901_no_flash_fw_36525b_auo_1211702.h"
#include "firmware/PD1901_no_flash_fw_36525b_auo_1211702_mp.h"
#include "firmware/PD1987F_EX_no_flash_fw_36525b_boe.h"
#include "firmware/PD1987F_EX_no_flash_fw_36525b_boe_mp.h"
#include "firmware/PD1987F_EX_no_flash_fw_dj_auo.h"
#include "firmware/PD1987F_EX_no_flash_fw_dj_auo_mp.h"
#include "firmware/PD1987F_EX_no_flash_fw_lc_boe.h"
#include "firmware/PD1987F_EX_no_flash_fw_lc_boe_mp.h"
...
static int32_t nvt_ts_probe(struct spi_device *client)
{
	...
	if (!strcmp(productName, "PD1987F_EX"))
	...
	vts_data->factory_mode = 0;
	vts_data->getIcMode = bbk_xxx_get_ic_mode;
	...
	vivoTsFwAdd(VTS_FW_TYPE_FW, PD1901_no_flash_fw, sizeof(PD1901_no_flash_fw), "PD1901", VTS_FW_NOPIN_VALUE, VTS_MVC_BOE, 0x3a);
	vivoTsFwAdd(VTS_FW_TYPE_MP, PD1901_no_flash_fw_mp, sizeof(PD1901_no_flash_fw_mp), "PD1901", VTS_FW_NOPIN_VALUE, VTS_MVC_BOE, 0x3a);

	vivoTsFwAdd(VTS_FW_TYPE_FW, PD1901_no_flash_fw_lc_boe, sizeof(PD1901_no_flash_fw_lc_boe), "PD1901", VTS_FW_NOPIN_VALUE, VTS_MVC_BOE, 0x51);
	vivoTsFwAdd(VTS_FW_TYPE_MP, PD1901_no_flash_fw_lc_boe_mp, sizeof(PD1901_no_flash_fw_lc_boe_mp), "PD1901", VTS_FW_NOPIN_VALUE, VTS_MVC_BOE, 0x51);

	vivoTsFwAdd(VTS_FW_TYPE_FW, PD1901_no_flash_fw_inx, sizeof(PD1901_no_flash_fw_inx), "PD1901", VTS_FW_NOPIN_VALUE, VTS_MVC_BOE, 0x61);
	vivoTsFwAdd(VTS_FW_TYPE_MP, PD1901_no_flash_fw_inx_mp, sizeof(PD1901_no_flash_fw_inx_mp), "PD1901", VTS_FW_NOPIN_VALUE, VTS_MVC_BOE, 0x61);

	vivoTsFwAdd(VTS_FW_TYPE_FW, PD1901_no_flash_fw_36525b_boe, sizeof(PD1901_no_flash_fw_36525b_boe), "PD1901", VTS_FW_NOPIN_VALUE, VTS_MVC_BOE, 0x3b);
	vivoTsFwAdd(VTS_FW_TYPE_MP, PD1901_no_flash_fw_36525b_boe_mp, sizeof(PD1901_no_flash_fw_36525b_boe_mp), "PD1901", VTS_FW_NOPIN_VALUE, VTS_MVC_BOE, 0x3b);
    vivoTsFwAdd(VTS_FW_TYPE_FW, PD1901_no_flash_fw_36525b_boe_1211701, sizeof(PD1901_no_flash_fw_36525b_boe_1211701), "PD1901", VTS_FW_NOPIN_VALUE, VTS_MVC_BOE, 0x52);
	vivoTsFwAdd(VTS_FW_TYPE_MP, PD1901_no_flash_fw_36525b_boe_1211701_mp, sizeof(PD1901_no_flash_fw_36525b_boe_1211701_mp), "PD1901", VTS_FW_NOPIN_VALUE, VTS_MVC_BOE, 0x52);

	vivoTsFwAdd(VTS_FW_TYPE_FW, PD1901_no_flash_fw_36525b_auo_1211702, sizeof(PD1901_no_flash_fw_36525b_auo_1211702), "PD1901", VTS_FW_NOPIN_VALUE, VTS_MVC_BOE, 0x41);
	vivoTsFwAdd(VTS_FW_TYPE_MP, PD1901_no_flash_fw_36525b_auo_1211702_mp, sizeof(PD1901_no_flash_fw_36525b_auo_1211702_mp), "PD1901", VTS_FW_NOPIN_VALUE, VTS_MVC_BOE, 0x41);

	vivoTsFwAdd(VTS_FW_TYPE_FW, PD1987F_EX_no_flash_fw_36525b_boe, sizeof(PD1987F_EX_no_flash_fw_36525b_boe), "PD1987F_EX", VTS_FW_NOPIN_VALUE, VTS_MVC_BOE, 0x30);
	vivoTsFwAdd(VTS_FW_TYPE_MP, PD1987F_EX_no_flash_fw_36525b_boe_mp, sizeof(PD1987F_EX_no_flash_fw_36525b_boe_mp), "PD1987F_EX", VTS_FW_NOPIN_VALUE, VTS_MVC_BOE, 0x30);

	vivoTsFwAdd(VTS_FW_TYPE_FW, PD1987F_EX_no_flash_fw_dj_auo, sizeof(PD1987F_EX_no_flash_fw_dj_auo), "PD1987F_EX", VTS_FW_NOPIN_VALUE, VTS_MVC_BOE, 0x40);
	vivoTsFwAdd(VTS_FW_TYPE_MP, PD1987F_EX_no_flash_fw_dj_auo_mp, sizeof(PD1987F_EX_no_flash_fw_dj_auo_mp), "PD1987F_EX", VTS_FW_NOPIN_VALUE, VTS_MVC_BOE, 0x40);

	vivoTsFwAdd(VTS_FW_TYPE_FW, PD1987F_EX_no_flash_fw_lc_boe, sizeof(PD1987F_EX_no_flash_fw_lc_boe), "PD1987F_EX", VTS_FW_NOPIN_VALUE, VTS_MVC_BOE, 0x50);
	vivoTsFwAdd(VTS_FW_TYPE_MP, PD1987F_EX_no_flash_fw_lc_boe_mp, sizeof(PD1987F_EX_no_flash_fw_lc_boe_mp), "PD1987F_EX", VTS_FW_NOPIN_VALUE, VTS_MVC_BOE, 0x50);

	vivoTsFwAdd(VTS_FW_TYPE_FW, PD1987F_EX_no_flash_fw_lc_boe, sizeof(PD1987F_EX_no_flash_fw_lc_boe), "PD1987F_EX", VTS_FW_NOPIN_VALUE, VTS_MVC_BOE, 0x51);
	vivoTsFwAdd(VTS_FW_TYPE_MP, PD1987F_EX_no_flash_fw_lc_boe_mp, sizeof(PD1987F_EX_no_flash_fw_lc_boe_mp), "PD1987F_EX", VTS_FW_NOPIN_VALUE, VTS_MVC_BOE, 0x51);
...
static int fb_notifier_callback(struct notifier_block *self, unsigned long event, void *data)
{
	...
	if (evdata && evdata->data && event == FB_EARLY_EVENT_BLANK) {
		...
		blank = evdata->data;
		VTI("Using NVT notifier callback");
...
static int32_t __init nvt_driver_init(void)
{
	...
	if (!strcmp(productName, "PD1987F_EX")) {
		if ((ret != 0x30) && (ret != 0x40) && (ret != 0x50) && (0x51 != ret)) {
			VTI("not spi module");
			return 0;
		}
	} else {
		if ((ret != 0x3a) && (ret != 0x3b) && (0x51 != ret) && (0x61 != ret)&& (0x52 != ret) && (0x41 != ret)) {
			VTI("not spi module");
			return 0;
		}
	}
