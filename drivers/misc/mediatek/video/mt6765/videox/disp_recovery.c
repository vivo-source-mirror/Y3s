 ...
 */
 /****************************************************
 lcd_need_reset : a flag of 0xED , this register can't be read by mipi
 lcd_need_reset = 1, 0xED is 0xAA , we need to reload initial code
 *****************************************************/
...
extern int nvt_ts_abnormal_reset_download_fw(void);
	...
	while (1) {
		...
		do {
			...
			********************************************************/
			...
			if (!strcmp(project_name, "PD1901")) {
			/*for BOE nt36525 and nt36525B, 3 manufactures of PD1901 use nt36525 */
			if (lcm_software_id == 0x61 || lcm_software_id == 0x64 || lcm_software_id == 0x6d)
					nvt_ts_abnormal_reset_download_fw();
				}
