 ...
 *============================================================================
 ****************************************************************************/
#define PFX "S5K3L6XXPD2074_camera_sensor"
...
#include "s5k3l6xxpd2074mipiraw_Sensor.h"
...
static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = S5K3L6XXPD2074_SENSOR_ID,
...
MUINT32  sn_inf_main_s5k3l6xx[13];  /*0 flag   1-12 data*/ 
...
static kal_uint32 get_imgsensor_id(UINT32 *sensor_id)
{
	...
	while (imgsensor_info.i2c_addr_table[i] != 0xff) {
		...
		if(vivo_read_eeprom(1,&temp_val)){
			if(temp_val!=0x05){  //0x05:qtech  0x02:truly
				*sensor_id = 0xFFFFFFFF;
				return ERROR_SENSOR_CONNECT_FAIL;
			}
		}
