...
static struct LCM_setting_table init_setting_12bit[] = {
	...
	{0xFF, 3, {98, 0x81, 0x03} },// CABC SETTING
	{0x90, 1, {0x0F} },
	{0x94, 1, {0x05} },
	{0xA8, 1, {0xC0} },
	{0xAD, 1, {0xE3} },
	...
	{0x00, 58, {0x00, 0x04, 0x08, 0x0C, 0x10, 0x14, 0x18, 0x1C, 0x20, 0x25, 0x28, 0x2C, 0x31, 0x35, 0x39, 0x3D, 0x41, 0x45, 0x49, 0x4D, 0x51, 0x55, 0x59, 0x5D, 0x61, 0x65, 0x69, 0x71, 0x79, 0x81, 0x89, 0x91, 0x99, 0xA1, 0xA8, 0xB1, 0xB8, 0xC0, 0xC9, 0xD0, 0xD8, 0xE0, 0xE8, 0xF0, 0xF8, 0x00, 0x40, 0xE9, 0xF3, 0x80, 0x6F, 0x54, 0x00, 0x41, 0x32, 0xCA, 0x6A, 0x00} },
	{0xFE, 58, {0x00, 0x04, 0x07, 0x0B, 0x0F, 0x13, 0x17, 0x1B, 0x1F, 0x23, 0x27, 0x2A, 0x2E, 0x32, 0x36, 0x3A, 0x3E, 0x42, 0x46, 0x49, 0x4D, 0x51, 0x55, 0x59, 0x5C, 0x60, 0x64, 0x6B, 0x73, 0x7B, 0x83, 0x8A, 0x92, 0x9A, 0xA1, 0xA9, 0xB1, 0xB8, 0xC0, 0xC8, 0xD0, 0xD8, 0xDF, 0xE7, 0xEF, 0xF7, 0xF0, 0x5E, 0x84, 0x5A, 0xD6, 0x01, 0xCB, 0xC6, 0x66, 0xE9, 0xB1, 0x05} },
	{0xFE, 58, {0x00, 0x03, 0x08, 0x0D, 0x10, 0x14, 0x17, 0x1B, 0x1F, 0x23, 0x27, 0x2B, 0x2F, 0x33, 0x37, 0x3C, 0x40, 0x44, 0x48, 0x4C, 0x4F, 0x53, 0x57, 0x5B, 0x5F, 0x63, 0x67, 0x6F, 0x77, 0x7F, 0x86, 0x8E, 0x96, 0x9D, 0xA5, 0xAD, 0xB4, 0xBC, 0xC4, 0xCC, 0xD4, 0xDB, 0xE2, 0xEA, 0xF2, 0xFA, 0x2C, 0xAB, 0xBE, 0x7F, 0x1A, 0xFF, 0x5B, 0xA0, 0x1E, 0x16, 0xB4, 0x09} },
	{0xFF, 3, {0x98, 0x81, 0x08} },
	{0xE0, 27, {0x00, 0x06, 0x43, 0x6D, 0xA7, 0x50, 0xD7, 0xFD, 0x2C, 0x52, 0x95, 0x8D, 0xBF, 0xEA, 0x14, 0xAA, 0x3F, 0x73, 0x95, 0xC1, 0xFE, 0xE7, 0x19, 0x56, 0x87, 0x03, 0xA3} },
	{0xE1, 27, {0x00, 0x06, 0x43, 0x6D, 0xA7, 0x50, 0xD7, 0xFD, 0x2C, 0x52, 0x95, 0x8D, 0xBF, 0xEA, 0x14, 0xAA, 0x3F, 0x73, 0x95, 0xC1, 0xFE, 0xE7, 0x19, 0x56, 0x87, 0x03, 0xC8} },
	{0xFF, 3, {0x98, 0x81, 0x00} },
...
{
	LCM_INFO("%s qunchuang ili9881h -> enter power on begin, panel_reset_state=%d\n", __func__, panel_reset_state);
	...
	************************************/
		...
		LCM_INFO("%s pd1901_qunchuang_ili9881h_noflash_hdp_dsi_vdo -> enter power on end\n", __func__);
	}
}
...
static void lcm_suspend_power(void)
{
	...
	lcm_enp_setting(0);
	MDELAY(5);
	pr_err("[LCM]ili9881h- vddi keep high level\n");
	panel_reset_state = 0;// clear reset state
}

static void lcm_init(void)
{
	pr_err("[LCM]ili9881h- init begin\n");
	lcm_reset_setting(1);
	MDELAY(10);
	lcm_reset_setting(0);
	MDELAY(3);
	...
	But PD1901 use no-flash version ili9881h, so 15ms is enough, NolenCheng confirmed 0304
	******************************************************************/
	MDELAY(13);
...
static void lcm_suspend(void)
{
	push_table(lcm_suspend_setting,
		...
		1);
	panel_off_state = 1;
	pr_err("[LCM]ili9881h- lcm_suspend display off\n");
}
...
struct LCM_DRIVER pd1901_qunchuang_ili9881h_noflash_hdp_dsi_vdo_lcm_drv = {
	.name = "pd1901_qunchuang_ili9881h_noflash_hdp_dsi_vdo",
